  ...
  return (
    <div className="space-y-7">
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          onClick={create}
          className="flex items-center gap-2 text-sm font-semibold px-5 py-3 rounded-2xl bg-accent text-white hover:bg-accent-dark transition-all active:scale-[.97] touch-press min-h-[44px]"
          type="button"
        >
      ...
      {sorted.length === 0 ? (
        <Card>
          <EmptyState
            ...
            subtitle="Record your net worth to start tracking it over time."
            action={
              <button
                onClick={create}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {breakdown.length > 0 && (
                      <button
                        ...
                        className="p-2 rounded-xl hover:bg-surface-2 dark:hover:bg-white/5 text-ink-muted dark:text-white/35 transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
                        type="button"
                      >
                    ...
                    <button
                      onClick={() => del(snap.id)}
                      className="p-2 rounded-xl hover:bg-loss-light dark:hover:bg-loss/10 text-ink-muted/30 hover:text-loss transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
                      type="button"
                    >
                      <Trash2 size={15} />
                    </button>
