            ...
            {settingsReady &&
              (isPro ? (
                <button
                  ...
                  type="button"
                >
                  {inflationAdj ? '📉 Real (2.5% inflation adjusted)' : '💰 Future value (nominal)'}
                </button>
              ) : (
                <button
                  ...
                  type="button"
                >
                  <Crown size={11} /> Inflation adjusted model
                </button>
              ))}
          ...
          <div className="relative w-full max-w-[560px] bg-white dark:bg-surface-dark-2 rounded-3xl shadow-card-lg border border-black/[.06] dark:border-white/[.08] p-6 sm:p-7">
            <div className="flex items-start justify-between gap-4 mb-5">
              <div>
                ...
                <div className="text-sm text-ink-muted/60 dark:text-white/30 mt-1">Update your target and timeline.</div>
              </div>
              <button
                onClick={closeEdit}
